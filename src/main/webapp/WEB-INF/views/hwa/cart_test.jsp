                            ...
                            <div class="order-cart-list cart" id="cart13397717" data-cart-id="13397717"
                                ...
                                <div class="item ing">
                                    ...
                                    <div class="order-list-wrap">
                                        ...
                                        <div class="btn-unit">
                                            <form action="/cart/${cartProdDto.CART_ID}" method="post" class="quantity_delete_form
                                            ">
                                            <button type="button" class='btn btn-like cartLikeBtn'
                                                    data-goods-id="BO00110144">좋아요
                                            </button>
                                            <button type="button" class="btn btn-delete cartDelBtn"
...
<script>
    $(document).ready(function() {
        ...
        $(".cartDelBtn").click(function() {
            var cartId = $(this).data("cartid"); //data 속성으로 cartId
            var prodNo = $(this).data("prodno"); //data 속성으로 prodNo
            var cartWrapper = $(this).closest('.order-cart-wrapper');  // order-cart-wrapper의 가장 가까운 조상 -> order-cart-body
