...
<%--                                            </div>--%>
                                            <p>
                                                <a href="#" onclick="openNewWindow();">2023.05.15</a>
                                            </p>
                                            <!-- <p class="txtCode">(P000000J)</p>
                                            <input type="hidden" name="product_no_list[]" value="10"> -->
                                        </div>
                                    </td>
                                    <td rowspan="1" id="total-qty-{{inv.prod_ID}}" data-prod-id="{{inv.prod_ID}}">20230511163371</td>

                                    <td rowspan="1" id="total-qty-{{inv.prod_ID1}}" data-prod-id="{{inv.prod_ID}}"><a href="#" onclick="openNewWindow()" >더마 그린티 프로바이오틱스 크림</a></td>
                                    <td>22,500원
                                        <input type="hidden" class="cate-cd" name="cate-cd" value="P000000J000A">
                                    </td>
                                    <td rowspan="1" id="total-qty-{{inv.prod_ID2}}" data-prod-id="{{inv.prod_ID}}">입금대기</td>
                                    <td rowspan="1" id="total-qty-{{inv.prod_ID3}}" data-prod-id="{{inv.prod_ID}}">운송장 입력</td>
