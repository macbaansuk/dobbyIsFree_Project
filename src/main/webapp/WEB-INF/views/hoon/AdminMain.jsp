                ...
                <div class="dashboardArea">
                    <div class="mDashboard">
                        <div class="title">
                                    ...
                                    <p class="today"><strong>05월 11일</strong> 수요일</p>
                        </div>
...
<%--            <!-- 주문처리 현황 -->--%>
<%--            <div id="tabMallStatus2" class="tabMallStatus">--%>
<%--                <div class="mallArea">--%>
<%--                    <div class="mBoard">--%>
<%--                        <table border="1" summary="">--%>
...
<%--            <!-- 회원/적립금 현황 -->--%>
<%--            <div id="tabMallStatus3" class="tabMallStatus">--%>
<%--                <div class="mallArea">--%>
<%--                    <div class="gFlow graph">--%>
...
<%--            <!-- 게시물 현황 -->--%>
<%--            <div id="tabMallStatus5" class="tabMallStatus">--%>
<%--                <div class="mallArea">--%>
<%--                    <div class="mBoard">--%>
<%--                        <table border="1" summary="">--%>
