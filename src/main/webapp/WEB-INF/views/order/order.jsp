                                    ...
                                    <td>
                                        <div class="selectArea" style="width: 75%;">
                                            ...
                                            <ul class="selList" id="cpnSelList" style="display: none;">
                                                ...
                                                <%--                                                <label for="userCoupon0"><span class="couponName">[배송비무료쿠폰] 신규 가입 기념 무료 배송 쿠폰 (5000원 이상 구매시 사용가능)</span>--%>
                                                <%--&lt;%&ndash;                                                    <em>0%</em>&ndash;%&gt;--%>
                                                <%--                                                </label>--%>
                                                <%--                                            </li>--%>

                                                <li name="coupon" $cpnseq="21050049" $prdseq="0" $cpnclcd="posCoupon" $cpntpcd="" $cpnnm="[신규]1만원이상 2천원할인" $cpnno="21050049" $cpnprc="2000"  $mxdcamt="2000" $maxordamt="0" $cpnprctp="1" $prdnm="" $webyn="" $mobileyn="" $appyn="" $stdatetime="" $enddatetime="2023-05-08" $unitprc="10000" $prdrwrdprdpmtnafl="N" $amtrwrdprdpmtnafl="N" $btyptpmtnafl="Y" $btyptusenafl="Y" $idx="0" $cdnm="" $cpnclnm="" $cpnorderby="6" $useablecpnyn="" $inmprdcatcpntpcd="" $inmprdcatcd1="" $extradctypeyn="N" $catcd="" $skttdaycpnyn="" $sktusecpnonlyyn="" id="21050049" style="display: block;">
                                                    <input class="couponSeq" type="radio" name="couponSeq" id="userCoupon6" value="2000" $cpnclcd="posCoupon" $cpnorderby="6" $useablecpnyn="undefined" $webyn="undefined" $mobileyn="undefined" $appyn="undefined" $extradctypeyn="">
                                                    <label for="userCoupon6"><span class="couponName">[신규]1만원이상 2천원할인</span><em>-2000 원</em></label>
                                                </li>
                                                <li name="coupon" $cpnseq="21050050" $prdseq="0" $cpnclcd="posCoupon" $cpntpcd="" $cpnnm="[신규]2만원이상 5천원할인" $cpnno="21050050" $cpnprc="5000" $mxdcamt="5000" $maxordamt="0" $cpnprctp="1" $prdnm="" $webyn="" $mobileyn="" $appyn="" $stdatetime="" $enddatetime="2023-05-08" $unitprc="20000" $prdrwrdprdpmtnafl="N" $amtrwrdprdpmtnafl="N" $btyptpmtnafl="Y" $btyptusenafl="Y" $idx="0" $cdnm="" $cpnclnm="" $cpnorderby="7" $useablecpnyn="" $inmprdcatcpntpcd="" $inmprdcatcd1="" $extradctypeyn="N" $catcd="" $skttdaycpnyn="" $sktusecpnonlyyn="" id="21050050" style="display: block;">
                                                    <input class="couponSeq" type="radio" name="couponSeq" id="userCoupon7" value="5000" $cpnclcd="posCoupon" $cpnorderby="7" $useablecpnyn="undefined" $webyn="undefined" $mobileyn="undefined" $appyn="undefined" $extradctypeyn="">
                                                    <label for="userCoupon7"><span class="couponName">[신규]2만원이상 5천원할인</span><em>-5000 원</em></label>
                                                </li>
                                                <li name="coupon" $cpnseq="21050051" $prdseq="0" $cpnclcd="posCoupon" $cpntpcd="" $cpnnm="[신규]3만원이상 1만원할인" $cpnno="21050051" $cpnprc="10000"  $mxdcamt="10000" $maxordamt="0" $cpnprctp="1" $prdnm="" $webyn="" $mobileyn="" $appyn="" $stdatetime="" $enddatetime="2023-05-08" $unitprc="30000" $prdrwrdprdpmtnafl="N" $amtrwrdprdpmtnafl="N" $btyptpmtnafl="Y" $btyptusenafl="Y" $idx="0" $cdnm="" $cpnclnm="" $cpnorderby="8" $useablecpnyn="" $inmprdcatcpntpcd="" $inmprdcatcd1="" $extradctypeyn="N" $catcd="" $skttdaycpnyn="" $sktusecpnonlyyn="" id="21050051" style="display: block;">
                                                    <input class="couponSeq" type="radio" name="couponSeq" id="userCoupon8" value="10000" $cpnclcd="posCoupon" $cpnorderby="8" $useablecpnyn="undefined" $webyn="undefined" $mobileyn="undefined" $appyn="undefined" $extradctypeyn="">
                                                    <label for="userCoupon8"><span class="couponName">[신규]3만원이상 1만원할인</span><em>-10000 원</em></label>
                                                </li>
                                            </ul>
                                        </div>
