  ...
  <div id="personInfo">
    <table class="person-tb">
      ...
      <tr>
        ...
        <td>
          <div class="col-cell">
            <input placeholder="휴대폰 번호(숫자만)" type="tel" name="MPNO" form="join_form" id="etcphone" class="MS_input_tel normal-input"
