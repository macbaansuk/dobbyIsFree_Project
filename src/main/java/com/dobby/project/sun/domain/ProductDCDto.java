...
public class ProductDCDto {
    ...
    public ProductDCDto(Integer prod_dc_id, String prod_nm, Integer prod_id, String dc_typ, Integer dc_rate, Integer dc_amt, Integer dc_price, Date bgn_dtm, Date end_dtm, String dc_stus, Date fst_reg_dtm, String fst_regr_dcmt_no, Date last_upd_dtm, String last_updr_dcmt_no, String cate_cd, Integer amt, String rep_img, Integer avg_ascr, Integer revw_ncnt, String new_yn, String prod_stus, String opt_yn, String prod_desc, String dc_yn, String mai_yn, String fgift_yn, Date upd_dtm, Date reg_dtm) {
