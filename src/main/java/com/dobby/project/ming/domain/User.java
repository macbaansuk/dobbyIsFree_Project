...
public class User {
    ...
    public User(String MBR_ID, String PWD, String MBR_NM, String EMAIL, String MPNO, Date BD, String SEX, String AGRE_YN, String MBR_GRD, String MBR_TYPE_CD, String MBR_STUS_CD, String DLVPN_ID, Integer MBR_PT, String MBR_COUPN, String COMMENT, String SNS_YN, Date SUBS_DTM, Date MBR_GRD_DTM, String CONN_TMS, Date LAST_LOGIN_DTM, Date FST_REG_DTM, String FST_REGR_DCMT_NO, Date LAST_UPD_DTM, String LAST_UPDR_DCMT_NO, Date SNS_DTM) {
        this.MBR_ID = MBR_ID;
        this.PWD = PWD;
        this.MBR_NM = MBR_NM;
        this.EMAIL = EMAIL;
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return MBR_ID.equals(user.MBR_ID) && PWD.equals(user.PWD) && MBR_NM.equals(user.MBR_NM) && EMAIL.equals(user.EMAIL)
                && MPNO.equals(user.MPNO) && BD.equals(user.BD) && SEX.equals(user.SEX) && AGRE_YN.equals(user.AGRE_YN)
                && MBR_GRD.equals(user.MBR_GRD) && MBR_TYPE_CD.equals(user.MBR_TYPE_CD) && MBR_STUS_CD.equals(user.MBR_STUS_CD)
                && Objects.equals(DLVPN_ID, user.DLVPN_ID) && Objects.equals(MBR_PT, user.MBR_PT)
                && Objects.equals(MBR_COUPN, user.MBR_COUPN) && Objects.equals(COMMENT, user.COMMENT)
                && SNS_YN.equals(user.SNS_YN) && SUBS_DTM.equals(user.SUBS_DTM) && MBR_GRD_DTM.equals(user.MBR_GRD_DTM)
                && Objects.equals(CONN_TMS, user.CONN_TMS) && Objects.equals(LAST_LOGIN_DTM, user.LAST_LOGIN_DTM)
                && Objects.equals(FST_REG_DTM, user.FST_REG_DTM) && Objects.equals(FST_REGR_DCMT_NO, user.FST_REGR_DCMT_NO)
                && Objects.equals(LAST_UPD_DTM, user.LAST_UPD_DTM) && Objects.equals(LAST_UPDR_DCMT_NO, user.LAST_UPDR_DCMT_NO)
                && Objects.equals(SNS_DTM, user.SNS_DTM);
    }

    @Override
    public int hashCode() {
        return Objects.hash(MBR_ID, PWD, MBR_NM, EMAIL, MPNO, BD, SEX, AGRE_YN, MBR_GRD, MBR_TYPE_CD, MBR_STUS_CD, DLVPN_ID, MBR_PT, MBR_COUPN, COMMENT, SNS_YN, SUBS_DTM, MBR_GRD_DTM, CONN_TMS, LAST_LOGIN_DTM, FST_REG_DTM, FST_REGR_DCMT_NO, LAST_UPD_DTM, LAST_UPDR_DCMT_NO, SNS_DTM);
    }
    ...
    public String getAGRE_YN() { return AGRE_YN;}

    public void setAGRE_YN(String AGRE_YN) { this.AGRE_YN = AGRE_YN;}
