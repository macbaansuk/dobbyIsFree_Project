...
import com.dobby.project.admin.domain.PageHandler;
import com.dobby.project.admin.domain.invSearchCondition;
import com.dobby.project.admin.service.InvService;
...
//        return "admin/inv"; // 로그인을 한 상태이면, 게시판 화면으로 이동
    }
}
